...
app = BUNDLE(
    coll,
    name='IELTSVocab-dictation.app',
    icon=None,
    bundle_identifier='com.ieltsvocab.dictation',
    info_plist={
        'CFBundleName': 'IELTSVocab-dictation',
        'CFBundleDisplayName': '雅思词汇记忆-默写版',
